...
<body>
					...
					<ul class="nav navbar-nav navbar-right">
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								@if(file_exists('foto/'.Auth::user()->siswa->nisn.'.jpg'))
									<img src="{{asset('foto/'.Auth::user()->siswa->nisn.'.jpg')}}" width="90px" class="img-circle" alt="Avatar"> <span>{{ Auth::user()->name }}</span><span class="caret"></span>
								@else
									<img src="{{asset('foto/nofoto.png')}}" class="img-circle" alt="Avatar"> <span>{{ Auth::user()->name }}</span><span class="caret"></span>
								@endif
							</a>
	...
	<!-- MAIN CONTENT -->
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">&copy; 2020 <a href="#" target="_blank">- Team IT and Development SMKN 7 Pontianak -</a>. All Rights Reserved.</p>
			</div>
		</footer>
	</div>
	<!-- END WRAPPER -->
