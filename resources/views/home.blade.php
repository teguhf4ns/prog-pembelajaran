    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">D a t a</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">MAPEL</div>
                </div>
                <div class="col-auto">
                    <a href="{{ route('mapel.index') }}" class="badge badge-info badge-toastr"><i class="fas fa-info-circle fa-1x text-gray-100"></i> Lihat</button></a>
                </div>
                </div>
            </div>
            </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">J A D W A L</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">MAPEL</div>
                </div>
                <div class="col-auto">
                    <a href="{{ route('mapel.index') }}" class="badge badge-danger badge-toastr"><i class="fas fa-info-circle fa-1x text-gray-100"></i> Lihat</button></a>
                </div>
                </div>
            </div>
            </div>
